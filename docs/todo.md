...
| 6 | [Dashboard And Ops](./todos/04-dashboard-ops.md) | Independent upcoming/project pages and follow-controlled buy gating active |
...
- Dashboard: add simple source labels: Website, Chain, Both; verify follow-controlled buy gating on the next live opening.
